...
const FName AModularGasGameModeBase::NAME_AbilitySystemComponent("AbilitySystemComponent");
...
const FName AModularGasGameMode::NAME_AbilitySystemComponent("AbilitySystemComponent");
