...
void AModularGasCharacter::SetAbilitySystemComponent(UAbilitySystemComponent* InAbilitySystemComponent)
{
    check(EAbilitySystemComponentOwnerPolicy::CharacterOwned == OwnerPolicy);
